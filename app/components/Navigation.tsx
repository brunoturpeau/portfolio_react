...
export function Navigation(){
    return (
        <nav
            className={`bg-slate-200 dark:bg-black w-full absolute top-0 left-0 z-10 h-[52px] sm:static sm:h-screen sm:w-1/3`}>
            <ul className="h-full py-3 flex flex-row items-center justify-evenly sm:flex-col">
                ...
                <li className="item-nav">
                    <Link className="link-nav" href="/a-propos">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="16"
                            height="16"
                ...
                <li className="hidden item-nav">
                    <Link className="link-nav" href="/competences">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="16"
                            height="16"
                ...
                <li className="hidden item-nav">
                    <Link className="link-nav" href="/message">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="16"
                            height="16"
